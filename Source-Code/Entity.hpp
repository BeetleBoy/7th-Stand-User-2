...
public:
    ...
    bool load(const std::string& mapimage, sf::Vector2u tileSize, unsigned int width, unsigned int height)
    {
        ...
        if (mapimage.compare("Maps/hirosehouse1f.png") == 0)
        {
            ...
            printf("\n");
            int bsiz[2][36] =   {{ 448,  32,  32, 192,  64,  64, 224, 160, 192,  96,  64, 384,  32,  32,  32,  64, 128, 288, 288,  96,  32,  32, 128,  32,  32, 160,  32,  32,  32, 602,  32,  64,  32,  32,  32,  32},
                                 { 128, 288,  32,  32,  64, 160,  96,  96,  96,  96,  96, 128,  96,  32,  32,  96,  96,  96,  96,  96, 480, 192,  96,  96, 160,  96,  64, 160, 156,  96, 156,  32, 156, 224, 192,  32}};
            int bpos[2][36] =   {{  32,  32,  32, 224, 288, 416,  64, 320, 480, 480, 608, 672,1024, 640, 768,  64, 160, 320, 640, 960,  32, 192,  64, 224, 224, 256, 352, 416, 448, 448, 800, 928,1024, 192, 448, 448},
                                 {  64, 192, 512, 192, 256, 192, 384, 384, 288, 384, 384, 352, 480, 480, 512, 576, 576, 576, 576, 576, 544, 672, 960, 736,1024,1056, 864,1024, 672, 832, 672, 768, 672, 896, 928, 352}};
            bboxcount = 36;
            ...
            int csiz[2][20] =   {{  32,  32,  32,  32,  32,  32,  32,  32, 224, 128,  64, 128, 288, 288,  64, 128,  32,  32, 156, 608},
                                 {  32,  32,  32,  64,  64,  64,  64,  64,  32,  32,  32,  32,  32,  32,  32,  32,  32,  32,  32,  32}};
            int cpos[2][20] =   {{  32, 192, 576, 288, 128, 288, 608, 928,  64, 320,  64, 160, 320, 640, 960,  64, 224, 416, 256, 480},
                                 { 480, 864, 384, 352, 544, 544, 544, 544, 352, 352, 544, 544, 544, 544, 544, 928, 992, 992,1024, 800}};
            for (int i = 0; i < 20; i++)
            {
                sf::Vector2f s, p;
                s.x = csiz[0][i];
